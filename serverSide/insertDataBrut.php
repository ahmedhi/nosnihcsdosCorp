...
foreach($_POST['Nom'] as $key => $row) {
    ...
    $output =  "Nom : " . $_POST['Nom'][$key] . " prenom : " . $_POST['Prénom'][$key] . " tel : " . $_POST['Téléphone'][$key]
        ...
        . " \nstatut : " . $_POST['Statut'][$key] . " agent : " . $_POST['agent'][$key] . " Campagne : " . $_POST['Campagne'][$key]
        . " \nListe d appel : " . $_POST['Liste d\'appel'][$key] . " Date d appel : " . $_POST['Date d\'appel'][$key]
        ...
        . " \ncommentaire_appel : " . $_POST['commentaire_appel'][$key] . " prenom inter : " . $_POST['prenom inter'][$key]
    ...
    $sql = "INSERT INTO init_data (
            ...
            VALUES (
                    ...
                    '" . $_POST['agent'][$key] . "',
                    '" . $_POST['Campagne'][$key] . "',
                    '" . $_POST['Liste d\'appel'][$key] . "',
                    '" . $_POST['Date d\'appel'][$key] . "',
