...
$(document).ready(function() {
    ...
    /* $('#Confirm_mail').on('click', 'td.editor-edit', function (e) {
	 ...
	 var mytable = $("#Confirm_mail").DataTable({
     scrollX: true,
     processing: true,
     ajax: {
     ...
     buttons: [
       ...
       { extend: "edit", editor: editor, text: 'Modifier', formTitle: "Modifier l'enregistrementfier ", formButtons: ["Modifier"] },
       { extend: "remove", editor: editor, text: 'Supprimer', formTitle: "Supprimer l'enregistrement", formButtons: ["Supprimer"], formMessage:"Etes-vous sûr de vouloir supprimer la ligne" },
     ],
   });
} );