...
const JSalertSucces = (status, message) => {
  Swal.fire(status, message, "success");
};
const JSalertFailed = (status, message) => {
      ...
      $.ajax({
        ...
        success: (data) => {
          ...
          if(data === "New records created successfully"){
            JSalertSucces("Succès", "Les donnèes ont été bien enregistrées !");
          }
          else{
            JSalertFailed("Erreur", "Une erreur est survenue lors de la sauvegarde !");
          }
        },
      });
  ...
  $("#btn_convert").click(function (e) {
    ...
    $.ajax({
      ...
      success: function (result) {
        if(result === "script ok" ){ 
          JSalertSucces("Succès", "Les donnèes ont été bien converties !");
       } else {
        JSalertFailed("Erreur", "Une erreur est survenue lors de la convertion !");
       };
