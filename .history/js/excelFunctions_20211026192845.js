function displayDataHeader(sheet_data, nbr_col, table_output) {
...
function displayDataRows(sheet_data, nbr_col, table_output) {
...
$(document).ready(function() {
    ...
    excel_file.addEventListener('change', (event) => {
        ...
        reader.onload = function(event){
            ...
            //var isTableExist = $('#imported_table').length;

            if(sheet_data.length > 0)
            {
                var table_output = '<div id="imported_table" class="table-responsive">+\n' +
                    '                 <form id="data_import"> \n' +
                    '                   <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">';
                var nbr_col = 0;

                displayDataHeader(sheet_data, nbr_col, table_output);
                displayDataRows(sheet_data, nbr_col, table_output);
