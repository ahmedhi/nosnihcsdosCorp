...
$(document).ready(function() {
   ...
   /*  $('#Confirm_mail').on( 'click', 'tbody td:not(:first-child)', function (e) {
     ...
     buttons: [
       ...
       { extend: "edit", editor: editor, text: 'Modifier', formTitle: "Modifier", formButtons: ["Modifier"], confirm: { _: "Etes-vous sûr de vouloir supprimer %d lignes?" } },
       { extend: "remove", editor: editor, text: 'Supprimer', formTitle: "Supprimer", formButtons: ["Supprimer"] },
     ],
   });
} );