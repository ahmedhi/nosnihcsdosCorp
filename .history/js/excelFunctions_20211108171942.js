      ...
      $.ajax({
        ...
        success: (data) => {
          ...
          if(data === "New records created successfully"){
            ...
            JSalertFailed("Erreur", "Une erreur est survenue lors de la sauvegarde !",'error');
          }
        },
      });
  ...
  $("#btn_convert").click(function (e) {
    ...
    $.ajax({
      ...
      success: function (result) {
        if(result === "script ok" ){ 
          JSalertSucces("Succès", "Les donnèes ont été bien converties !","success");
       } else {
        JSalertFailed("Erreur", "Une erreur est survenue lors de la convertion !", "error");
       };
