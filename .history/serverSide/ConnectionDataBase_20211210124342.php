...
$servername = "ods-data-server-01.database.windows.net";
$username = "'admin-rods";
...
$conn = new mssql_connect($servername, $username, $password,$db);
...
$result = mysqli_query($conn, "SELECT * from  dbo.Import_Zoho_all");
