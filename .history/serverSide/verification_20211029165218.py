...
#----------------------------------------------------------------------
export('data_input')
excel_file_path = 'serverSide/pathMail/data_input.xlsx'
#df = pd.read_excel(excel_file_path, None)
#if 'Sheet1' in df.keys():
data= pd.read_excel("serverSide/pathMail/data_input.xlsx", sheet_name='MENU')
...
import os
os.remove("serverSide/pathMail/data_input.xlsx")
