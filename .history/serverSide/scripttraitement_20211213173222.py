...
mycursor1.execute("SELECT [Province (BE)],[Account Name],[Account Number],[Billing Street],[Billing Code],[Billing City],[Billing Province (BE)],[Phone (Account)],[Contact Owner] INTO Import_Zoho_Compte FROM input3_test")
