...
/* $nom2 = $_POST['nom2'][$key]; */
    ...
    $params = array($nom,$prenom,$telephone,$adresse,$ville,$code_postal,$statut,$agent,$campagne,$liste_appel,$date_appel,$forme_juridique,$nace_code,$nace_description,$contact_position,$numero_entreprise,$province,$website,$sexe,$mail_direct,$mail_general,$gsm,$tel_direct,$commentaire_appel,$prenom2);    
