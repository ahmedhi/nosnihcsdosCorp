            ...
            <div class="container-fluid" style="margin-top: 2rem">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" id="excel_data">
                        <a href="index_OutPutdata.html" class="myButton">DATA  ALL(Par DIVISION RODS)</a>
                        <a href="index_OutPutdata001.html" class="myButton">DATA  ALL(Unicité par numéro de téléphone)</a>
                        <!-- <button onclick="window.location.href='index_OutPutdata.html'"  class="button button2"> <i class="fas fa-database"></i> DATA ALL(Par Division Rods)</button> -->
                   <!-- <button onclick="window.location.href='index_OutPutdata001.html'" class="button button3"> <i class="fas fa-database"></i>DATA ALL (Unite par Numero de telephone)</button> -->
